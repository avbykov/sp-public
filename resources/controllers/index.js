...
module.exports.put = {
    ...
    description: (id, locale, description) => pg.result(update.description, [description, id, locale]),
    image: (id, locale, image, name) => pg.result(update.image, [image, name, id, locale]),
    sound: (id, locale, sound, name) => pg.result(update.sound, [sound, name, id, locale])
};
module.exports.get = {
    text: (id, locale) => rs.hGet(id, locale),
    description: (id, locale) => pg.oneOrNone(select.description, [id, locale]),
